...
// public update methods
    ...
    private void addBetween(E e, Node<E> predecessor, Node<E> successor) {
        ...
        // Atualizar tamanho e contador de modificações
        size++;
        modCount++;
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        // Copiar todos os elementos usando iterator
        for (E element : this) {
            cloned.addLast(element);
        }
    ...
    private class DoublyLinkedListIterator implements ListIterator<E> {
        ...
        public void remove() throws NoSuchElementException {
            ...
            // Determinar qual nó remover
            if (lastReturnedNode == nextNode) {
                // Foi chamado previous() antes
                nextNode = nextNode.getNext();
            } else {
                // Foi chamado next() antes
                prevNode = prevNode.getPrev();
                nextIndex--;
            }

            // Remover o nó usando o método da classe externa
        ...
        public void add(E e) {
            ...
            // Adicionar entre prevNode e nextNode
