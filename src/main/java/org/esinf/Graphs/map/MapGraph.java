package org.esinf.Graphs.map;

import org.esinf.Graphs.CommonGraph;
import org.esinf.Graphs.Edge;
import org.esinf.Graphs.Graph;
...
public class MapGraph<V, E> extends CommonGraph<V, E> {
    ...
    public Collection<Edge<V, E>> incomingEdges(V vert) {
        ...
        ArrayList<Edge<V, E>> inEdges = new ArrayList<>();
